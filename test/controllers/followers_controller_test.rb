...
class FollowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post followers_url, params: { follower: { followed_id: @follower.followed_id, follower_id: @follower.follower_id } }
    end
  ...
  test "should update follower" do
    patch follower_url(@follower), params: { follower: { followed_id: @follower.followed_id, follower_id: @follower.follower_id } }
